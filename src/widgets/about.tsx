export function About() {
  return (
    <div className='flex flex-col items-center justify-center w-full h-auto sm:h-[700px] gap-2 p-6 sm:py-0 sm:px-16 1370px:px-32 relative'>
      <img src="/sea-view-hotel.webp" alt="" className="absolute top-0 left-0 w-full h-full object-cover select-none" loading="lazy" draggable="false" />
      <div className='flex gap-0 1180px:gap-20 w-full items-start h-fit 1370px:h-[400px] relative z-[1]'>
        ...
        <div className='flex-1 flex flex-col gap-3 justify-between min-w-0 text-xl lg:text-2xl lg:leading-tight text-shadow'>
          ...
          <p>
            Игра At Dead of Night была выпущена в 2020 году с русскоязычным переводом от команды TDoT. В переводе обнаружилось много ошибок,
            машинный перевод и недостаточное внимание к деталям. Мы решили исправить это и создали свой бесплатный неофициальный русификатор с русскоязычной озвучкой, 
