...
export function DocumentsButton() {
	return (
		<>
			<a
				href="#documents"
				className="border-2 border-indigo-600 rounded-full px-6 py-2 text-white
					no-text-shadow hover:text-indigo-400 transition-colors flex
					items-center gap-3 text-lg w-fit"
			>
				<svg
			...
			<Modal title="Документы" width={600} id="documents">
				<ul className="text-xl">
					...
					<li>
						<a
							href="https://kupigolos.ru/order/4k-8S67wJ6BaP"
							className="w-fit"
						>
					...
					<li>
						<a
							...
							className="flex gap-1 items-center w-fit"
						>
							<DownloadIcon /> Скачать чек на покупку озвучки у Д. Боуза и
							других персонажей
						</a>
					</li>
				</ul>
